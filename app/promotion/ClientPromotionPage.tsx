  ...
  const [promotions, setPromotions] = useState(() => {
    if (initialContent?.promo_campaigns) {
      try {
        ...
        console.error('Error parsing promo_campaigns', e);
      }
    }
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {promotions.map((promo: any, idx: number) => {
                const PromoIcon = ICONS_MAP[promo.iconName] || Tag;
                return (
                <motion.div 
                  key={promo.id || idx}
                ...
                >
                  ...
                  <div className="p-8 flex flex-col flex-1 relative z-10">
                    <div className="flex items-center gap-2 mb-4">
                      <PromoIcon className="w-5 h-5 text-[#B8962E]" />
                    ...
                    <ul className="space-y-3 mb-8">
                      {promo.benefits && promo.benefits.map((benefit: string, bIdx: number) => (
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif text-brand-charcoal mb-6 whitespace-pre-wrap">
                  {initialContent?.promo_refer_title || "Refer a Friend, \nShare the Radiance"}
                </h2>
                <p className="text-brand-charcoal/70 text-lg leading-relaxed mb-8 whitespace-pre-wrap">
                  {initialContent?.promo_refer_desc || "At SHAZ Aesthetic Clinic, we believe that self-care is best shared. Introduce your friends to our premium treatments and you will both be rewarded with exclusive perks."}
                </p>
              ...
              >
                <div className="relative aspect-[4/5] rounded-[2rem] overflow-hidden shadow-2xl border-[8px] border-white">
                  <img 
                    src={initialContent?.promo_refer_img || "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=1200&auto=format&fit=crop"} 
            ...
            <div className="bg-brand-charcoal rounded-[2.5rem] overflow-hidden relative shadow-2xl">
              ...
              <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 items-center">
                <div className="p-12 md:p-20 flex flex-col justify-center">
                  ...
                  <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif text-white mb-6 leading-tight whitespace-pre-wrap">
                    {initialContent?.promo_gift_title || "The Gift of \nTimeless Elegance"}
                  </h2>
                  <p className="text-white/70 text-lg leading-relaxed mb-10 whitespace-pre-wrap">
                    {initialContent?.promo_gift_desc || "Looking for the perfect gift? SHAZ Aesthetic Clinic gift vouchers offer a luxurious experience and exceptional results. Treat your loved ones to bespoke aesthetic care."}
                  </p>
